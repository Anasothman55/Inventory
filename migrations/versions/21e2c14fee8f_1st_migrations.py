...
Revision ID: 21e2c14fee8f
Revises: 
Create Date: 2025-03-28 20:23:37.127335
...
def upgrade() -> None:
    ...
    sa.Column('beneficiary', sqlmodel.sql.sqltypes.AutoString(length=128), nullable=True),
    ...
    sa.Column('purchas_uid', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), nullable=True),
